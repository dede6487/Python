...
# the same content as "a". Afterwards let "a" point to 2 and delete "b". What
# will happen to the string "test" after deleting variable "b"?
...
a = 2
del b
# The garbage collector will, at some point, remove the string "test" because
